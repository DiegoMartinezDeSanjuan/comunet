...
export async function canReadCommunity(session: Session, communityId: string): Promise<boolean> {
  const adminRoles: UserRole[] = ['SUPERADMIN', 'OFFICE_ADMIN', 'MANAGER', 'ACCOUNTANT', 'VIEWER']
...
export function requirePermission(session: Session, permission: string, _context?: PermissionContext): boolean {
  // Generic permission check - extendable
  const permissionMap: Record<string, UserRole[]> = {
    'communities.read': ['SUPERADMIN', 'OFFICE_ADMIN', 'MANAGER', 'ACCOUNTANT', 'VIEWER'],
    ...
    'documents.read': ['SUPERADMIN', 'OFFICE_ADMIN', 'MANAGER', 'ACCOUNTANT', 'VIEWER'],
    'documents.manage': ['SUPERADMIN', 'OFFICE_ADMIN', 'MANAGER'],
    'providers.read': ['SUPERADMIN', 'OFFICE_ADMIN', 'MANAGER', 'ACCOUNTANT', 'VIEWER'],
